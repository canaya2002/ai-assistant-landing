...
const pageContent: RootContent = {
  en: {
    ...
    hero: {
      title: 'NORA for macOS',
      subtitle: 'Your personal AI assistant, natively on your Mac.',
      description: 'NORA for Mac is a powerful AI assistant designed to integrate seamlessly with macOS. It leverages the latest AI models, including GPT-4o and Gemini, to provide instant, secure, and intelligent support directly from your desktop. With native features like Quick Actions, Spotlight integration, and a sleek, modern interface, NORA feels like a natural extension of your Mac, boosting your productivity and creativity.',
      cta: 'Download for Mac',
    },
    demo: {
      title: 'A Truly Native Experience',
      features: [
        { id: 'chat', name: 'Direct Chat', image: '/images/macos-chat-demo.png', description: 'Converse naturally with NORA in a floating chat window that stays on top of your work.' },
        { id: 'widget', name: 'Menu Bar Access', image: '/images/macos-menubar-demo.png', description: 'Access AI instantly from your menu bar with a simple shortcut for quick queries and tasks.' },
        { id: 'signin', name: 'Cross-Device Sync', image: '/images/macos-sync-demo.png', description: 'Your data and conversations are securely synced across all your Apple devices, ensuring a seamless experience.' },
      ]
    },
    benefits: {
      title: 'Designed for macOS',
      items: [
        { icon: Zap, title: 'Optimized Performance', description: 'Engineered to be fast and lightweight, running smoothly on any Mac with Apple Silicon or Intel processors, ensuring NORA is always responsive.' },
        { icon: BrainCircuit, title: 'Deep Integration', description: 'Works with native macOS features like Siri Shortcuts, Quick Actions, and Spotlight for a unified, hands-free workflow and intelligent automation.' },
        { icon: ShieldCheck, title: 'On-Device Privacy', description: 'Your most sensitive data is processed locally on your Mac whenever possible, ensuring your personal information stays private and secure. NORA is built with a privacy-first philosophy.' },
        { icon: Users, title: 'Fluid Design', description: 'A beautiful interface that follows macOS design principles, including a dark mode and a clean layout that feels like a natural part of the system.' },
      ]
    },
    highlights: {
      ...
      items: [
        ...
        { title: 'Cross-Device Sync', description: 'Seamlessly transition from your Mac to your iPhone or iPad. Your conversation history and settings are always up-to-date and available wherever you are, thanks to our robust cloud infrastructure.', image: '/images/placeholder/cross-device-sync.jpg' },
        { title: 'Personalized Workflows', description: 'Create custom actions and shortcuts to automate repetitive tasks. NORA can integrate with other Mac apps to streamline your daily routines, from setting reminders to managing your calendar.', image: '/images/placeholder/workflows.jpg' },
    ...
    screenshots: {
      ...
      items: [
        ...
        { id: 'home', title: 'Menu Bar & Shortcuts', description: 'Access AI functions directly from your menu bar with a customizable shortcut. Our compact interface provides quick access to your most-used features without cluttering your desktop.', media: '/images/placeholder/home-screen-widgets.jpg', isGif: false },
      ],
    },
    useCases: {
    ...
    testimonials: {
      ...
      items: [
        {
          quote: 'NORA has completely changed how I organize my day. The menu bar access is a game-changer and the proactive suggestions are incredibly smart!',
          name: 'Alex Rivera',
          role: 'macOS Power User',
        ...
        {
          quote: 'I use NORA on both my Mac and iPhone, and the seamless sync is flawless. It\'s the perfect tool for staying productive.',
          name: 'Laura Diaz',
          role: 'Student & Researcher',
          avatar: '/images/avatar-4.png'
        },
        {
          quote: 'The minimalist macOS design is a fantastic touch. The app feels like a true part of my system, not just another app.',
          name: 'David Chen',
          role: 'UX Designer',
    ...
    faq: {
      ...
      items: [
        { q: 'Is NORA for Mac free to use?', a: 'Yes, NORA offers a generous free tier with core functionalities. Advanced features, such as deep integrations and priority support, are available with a NORA Pro subscription, which syncs across all your devices.' },
        ...
        { q: 'Does it work with Siri and Spotlight?', a: 'Absolutely. NORA deeply integrates with Siri Shortcuts, allowing you to create custom commands. It also works with Spotlight, letting you access NORA\'s power directly from your search bar for a seamless, hands-free experience.' },
        { q: 'What versions of macOS are supported?', a: 'NORA is optimized for macOS 12 Monterey and newer to take full advantage of modern APIs and privacy features. It is also compatible with macOS 11 Big Sur with minor limitations, ensuring a wide range of users can benefit from its features.' },
        ...
        { q: 'How is NORA different from other AI apps?', a: 'NORA stands out due to its deep native integration with macOS, its commitment to privacy with on-device processing, and a fluid user experience designed from the ground up for the Mac ecosystem. It\'s not just a chat app; it\'s a smart extension of your device.' },
        ...
        { q: 'Is NORA compatible with all Mac models?', a: 'Yes, NORA is designed to work flawlessly on a variety of Mac models, including iMac, MacBook, and Mac mini. The interface adapts to different screen sizes, providing an enhanced and more productive experience.' },
        { q: 'How do I get started with NORA for Mac?', a: 'Getting started is simple. Just download the app from our website, install it, sign in with your account, and you\'ll be ready to start your first conversation with NORA. The app includes an interactive tutorial to help you discover its main features.' },
      ]
    },
    cta: {
      title: 'Ready to Elevate Your Mac Experience?',
  ...
  return (
    <div className="min-h-screen bg-black text-white selection:bg-gray-400 selection:text-black">
      ...
      <main className="relative z-10">
        ...
        <div className="container mx-auto px-6">
          {/* El componente InteractiveDemoSection ahora usará las nuevas imágenes */}
