...
const AboutHeroSection = memo(function AboutHeroSection({ lang }: { lang: Language['code'] }) {
  ...
  return (
    <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 bg-black overflow-hidden flex items-center justify-center min-h-screen"> {/* Adjusted pt/pb */}
    ...
    <section className="relative py-20 md:py-40 bg-black overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          {/* Events */}
          <div className="space-y-24"> {/* Increased space between events */}
