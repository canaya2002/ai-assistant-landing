// app/HomePageClient.tsx - (NUEVO ARCHIVO - Componente de Cliente)
      ...
      <div className="relative z-30 container mx-auto px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <AnimateOnScroll className="delay-200">
             <h2 className="text-lg md:text-3xl text-white/90 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
